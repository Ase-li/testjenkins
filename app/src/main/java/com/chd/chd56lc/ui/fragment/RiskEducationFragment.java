...
public class RiskEducationFragment extends BaseFragment implements IClassRoomListView {
...
//        initDate();
    ...
    private void initDate() {
        classRoomPresenter.paginateByReq(page, count, 0);
    }
