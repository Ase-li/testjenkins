...
public class RateCouponFragment extends BaseFragment implements ICouponView {
    ...
    protected void initView() {
        tvRemark.setText("· 已累计获得加息");
        rcData.setVisibility(View.GONE);
        llNodata.setVisibility(View.VISIBLE);
        tvNoData.setText("暂无加息券");
        if (couponBeans == null)
...
//        initData();
    ...
    private void initData() {
        couponPresenter.getCouponList(page, 20, 2);
    }
