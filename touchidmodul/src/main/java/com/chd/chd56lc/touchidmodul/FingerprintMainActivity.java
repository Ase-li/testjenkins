package com.chd.chd56lc.touchidmodul;
...
public class FingerprintMainActivity extends Activity implements View.OnClickListener {
    ...
    private void initFingerprintCore() {
        mFingerprintCore = new FingerprintCore(this,false);
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.fingerprint_recognition_start) {
            startFingerprintRecognition();

        } else if (viewId == R.id.fingerprint_recognition_cancel) {
            cancelFingerprintRecognition();

        } else if (viewId == R.id.fingerprint_recognition_sys_unlock) {
            startFingerprintRecognitionUnlockScreen();

        } else if (viewId == R.id.fingerprint_recognition_sys_setting) {
